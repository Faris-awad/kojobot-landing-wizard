      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div className="p-6 text-right"> {/* Added text-right here */}
              <div className="mb-8">
                <h4 className="font-bold text-lg mb-2 text-kojobot-purple">المرحلة التمهيدية</h4>
                <ul className="space-y-2">
                  <li className="flex items-start flex-row-reverse"> {/* Changed flex direction */}
                    <span className="ml-2">•</span> {/* Changed mr-2 to ml-2 */}
